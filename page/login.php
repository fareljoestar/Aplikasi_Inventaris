...
.container {
  display: flex;
  margin: 0 auto;
  max-width: 640px; /* Ganti dengan lebar maksimal yang Anda inginkan */
}
...
.left {
  ...
  position: relative;
  width: 50%;
  max-width: 320px; /* Ganti dengan lebar maksimal yang Anda inginkan */
  margin: 0 auto; /* Tambahkan baris ini */
}
@media (max-width: 767px) {
  .left {
    height: 100%;
  ...
  <div class="container">
    ...
    <div class="right">
      ...
      <div class="form">
        ...
        <input type="submit" type="submit" name="masuk" value="Submit">
      </div>
    </div>
  </div>
</div>
