        ...
        <div class="panel-body">
            <table class="table table-bordered table striped">
                ...
                <tbody>
                    ...
                    left join inventaris on inventaris.id_inventaris = detail_pinjam.id_inventaris left join pegawai on pegawai.id_pegawai = 
                    peminjaman.id_pegawai WHERE peminjaman.status_peminjaman ='1'";
